    ...
    <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <form action="<?= $baseUrl ?>/auth/register/process" method="POST" class="space-y-6">
                ...
                <div class="flex items-center">
                    ...
                    <label for="terms" class="ml-2 block text-sm text-gray-700">
                        I agree to the <a href="<?= $baseUrl ?>/terms" class="text-green-600 hover:text-green-500">Terms of Service</a> and <a href="<?= $baseUrl ?>/privacy" class="text-green-600 hover:text-green-500">Privacy Policy</a>
                    </label>
                </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
            <p class="text-center text-sm text-gray-600">
                ...
                <a href="<?= $baseUrl ?>/auth/login" class="font-medium text-green-600 hover:text-green-500">
                    Sign in
                </a>
            </p>
        </div>
