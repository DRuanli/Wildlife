...
<div class="container mx-auto px-4 py-8">
    ...
    <nav class="text-sm breadcrumbs mb-6">
        <ol class="list-none p-0 inline-flex">
            ...
            <li>
                <span class="text-gray-700"><?= htmlspecialchars($item['name']) ?></span>
            </li>
        </ol>
    </nav>
...
document.addEventListener('DOMContentLoaded', function() {
    // Initialize the model viewer once Three.js is loaded
    if (typeof THREE !== 'undefined' && typeof ModelViewer !== 'undefined' && typeof ArcticShimmerHare !== 'undefined') {
...
// ==========================================================
// 6. Update shop/index.php - Add Arctic Shimmer Hare
// ==========================================================
// File: /Wildlife/resources/views/shop/index.php

/*
<!-- Inside the "eggs" section or where appropriate -->
