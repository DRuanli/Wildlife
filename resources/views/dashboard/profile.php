    ...
    <div class="max-w-3xl mx-auto">
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="w-full md:w-1/3 mb-6 md:mb-0 flex flex-col items-center">
                        <div class="w-32 h-32 rounded-full bg-gray-200 overflow-hidden mb-4">
                            <?php if (!empty($user['avatar_url'])): ?>
                                <img src="<?= htmlspecialchars($user['avatar_url']) ?>" alt="Profile Avatar" class="w-full h-full object-cover">
                            <?php else: ?>
                        ...
                        <input type="file" name="avatar" accept="image/*" class="text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                    ...
                    <div class="w-full md:w-2/3 md:pl-6">
                        <div class="mb-4">
                            ...
                            <input type="text" name="username" id="username" value="<?= htmlspecialchars($user['username'] ?? '') ?>" class="w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        </div>
                        
                        <div class="mb-4">
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                            <input type="email" name="email" id="email" value="<?= htmlspecialchars($user['email'] ?? '') ?>" class="w-full rounded-md border-gray-300 shadow-sm bg-gray-50" readonly>
                            <p class="mt-1 text-xs text-gray-500">Email cannot be changed.</p>
                        </div>
                        
                        <div class="mb-4">
                            <label for="bio" class="block text-sm font-medium text-gray-700 mb-1">Bio</label>
                            <textarea name="bio" id="bio" rows="4" class="w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"><?= htmlspecialchars($user['bio'] ?? '') ?></textarea>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-6">
                ...
                <!-- Placeholder for focus charts - would be implemented with Chart.js or similar library -->
