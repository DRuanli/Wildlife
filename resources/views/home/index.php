        ...
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 mb-10 md:mb-0">
                ...
                <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                    <a href="<?= $baseUrl ?>/auth/register" class="inline-block px-6 py-3 bg-green-600 text-white font-medium rounded-lg text-center hover:bg-green-700 transition">
                        Get Started
                    </a>
            ...
            <div class="md:w-1/2">
                <img src="<?= $baseUrl ?>/images/landing-hero.png" alt="Wildlife Haven App" class="rounded-lg shadow-xl">
            </div>
        </div>
    </div>
    ...
    <div class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <!-- Testimonials 2 & 3 content removed for brevity -->
            </div>
        </div>
    </div>
