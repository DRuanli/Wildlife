            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <a href="/" class="flex items-center">
                        <img src="/images/logo.png" alt="Wildlife Haven Logo" class="h-10 w-auto mr-2">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in']): ?>
                        <a href="/dashboard" class="px-3 py-2 rounded hover:bg-green-700">Dashboard</a>
                        <a href="/focus" class="px-3 py-2 rounded hover:bg-green-700">Focus</a>
                        <a href="/creatures" class="px-3 py-2 rounded hover:bg-green-700">Creatures</a>
                        <a href="/habitats" class="px-3 py-2 rounded hover:bg-green-700">Habitats</a>
                        <a href="/marketplace" class="px-3 py-2 rounded hover:bg-green-700">Marketplace</a>
                        <a href="/conservation" class="px-3 py-2 rounded hover:bg-green-700">Conservation</a>
                        <a href="/community" class="px-3 py-2 rounded hover:bg-green-700">Community</a>
                    ...
                    <?php else: ?>
                        <a href="/auth/login" class="px-3 py-2 rounded hover:bg-green-700">Sign In</a>
                        <a href="/auth/register" class="px-3 py-2 bg-white text-green-600 font-medium rounded hover:bg-gray-100">Sign Up</a>
                    <?php endif; ?>
                </div>
