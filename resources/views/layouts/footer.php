                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <ul class="mt-4 space-y-2">
                            ...
                            <li><a href="/focus" class="text-gray-400 hover:text-white">Focus Timer</a></li>
                            <li><a href="/creatures" class="text-gray-400 hover:text-white">Creatures</a></li>
                            <li><a href="/habitats" class="text-gray-400 hover:text-white">Habitats</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="mt-4 space-y-2">
                            ...
                            <li><a href="/conservation" class="text-gray-400 hover:text-white">Conservation</a></li>
                            <li><a href="/community" class="text-gray-400 hover:text-white">Forums</a></li>
                            <li><a href="/community/leaderboard" class="text-gray-400 hover:text-white">Leaderboard</a></li>
                        </ul>
                    </div>
