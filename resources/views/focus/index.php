                        ...
                        <div id="timer-settings" class="w-full max-w-md">
                            <div class="mb-4">
                                ...
                                <div class="flex justify-between gap-2">
                                    <button class="duration-btn flex-1 py-2 rounded text-center font-medium bg-green-600 text-white"
                                            data-duration="25">25m
                                    </button>
                                    <button class="duration-btn flex-1 py-2 rounded text-center font-medium bg-gray-200 text-gray-700"
                                            data-duration="30">30m
                                    </button>
                                    <button class="duration-btn flex-1 py-2 rounded text-center font-medium bg-gray-200 text-gray-700"
                                            data-duration="45">45m
                                    </button>
                                    <button class="duration-btn flex-1 py-2 rounded text-center font-medium bg-gray-200 text-gray-700"
                                            data-duration="60">60m
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select id="creature-select"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500 bg-white">
